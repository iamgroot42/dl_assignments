...
def segnet2D_noob():
	...
	addConv_BatchNorm(16, 3, 3, segnet2D_noob_model, addInput = True)
	addConv_BatchNorm(16, 3, 3, segnet2D_noob_model)
	segnet2D_noob_model.add(MaxPooling2D(border_mode = 'same'))

	addConv_BatchNorm(8, 3, 3, segnet2D_noob_model)
	addConv_BatchNorm(8, 3, 3, segnet2D_noob_model)
	segnet2D_noob_model.add(MaxPooling2D(border_mode = 'same'))

	addConv_BatchNorm(4, 3, 3, segnet2D_noob_model)
	addConv_BatchNorm(4, 3, 3, segnet2D_noob_model)
	addConv_BatchNorm(4, 3, 3, segnet2D_noob_model)
	segnet2D_noob_model.add(MaxPooling2D(border_mode = 'same'))
	...
	addDeconv_BatchNorm(2, 3, 3, segnet2D_noob_model)
	addDeconv_BatchNorm(2, 3, 3, segnet2D_noob_model)
	addDeconv_BatchNorm(2, 3, 3, segnet2D_noob_model)
	segnet2D_noob_model.add(UpSampling2D())

	addDeconv_BatchNorm(4, 3, 3, segnet2D_noob_model)
	addDeconv_BatchNorm(4, 3, 3, segnet2D_noob_model)
	addDeconv_BatchNorm(4, 3, 3, segnet2D_noob_model)
	segnet2D_noob_model.add(UpSampling2D())

	addDeconv_BatchNorm(8, 3, 3, segnet2D_noob_model)
	addDeconv_BatchNorm(8, 3, 3, segnet2D_noob_model)
	addDeconv_BatchNorm(8, 3, 3, segnet2D_noob_model)
	segnet2D_noob_model.add(UpSampling2D())

	addDeconv_BatchNorm(16, 3, 3, segnet2D_noob_model)
	addDeconv_BatchNorm(16, 3, 3, segnet2D_noob_model)
	addDeconv_BatchNorm(16, 3, 3, segnet2D_noob_model)
	segnet2D_noob_model.add(UpSampling2D())
